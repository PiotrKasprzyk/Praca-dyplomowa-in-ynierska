...
def login():
    ...
    if 'last_failed_attempt_time' not in session:
        session['last_failed_attempt_time'] = 0
    ...
    if request.method == 'POST':
        if session['failed_attempts'] >= 3:
            time_since_last_attempt = time.time() - session['last_failed_attempt_time']
            if time_since_last_attempt < cooldown_time:
                time_remaining = int(cooldown_time - time_since_last_attempt)
                flash(f'Za dużo nieudanych prób logowania. Spróbuj ponownie za {time_remaining} sekund.', 'danger')
                return render_template('login.html', time_remaining=time_remaining)
            else:
                session['failed_attempts'] = 0
...
def plan():
    ...
    "location": "Siłownia",
    "experience": "Średnio zaawansowany",
    "equipment": "Pełny dostęp do siłowni",
    "health_limitations": "Brak",
    "details": [
                {
    "day": "Poniedziałek",
    "workout": "Klatka piersiowa i triceps",
    "exercises": [
        {"name": "Wyciskanie na ławce", "sets": 4, "reps": "8-10"},
        {"name": "Wyciskanie hantli na ławce skośnej", "sets": 4, "reps": "8-10"},
        {"name": "Rozpiętki na bramie", "sets": 3, "reps": "10-12"},
        {"name": "Pompki na poręczach (triceps)", "sets": 3, "reps": "10-12"},
        {"name": "Wyciskanie francuskie", "sets": 3, "reps": "10-12"}
    ]
},
{
    "day": "Środa",
    "workout": "Plecy i biceps",
    "exercises": [
        {"name": "Podciąganie na drążku", "sets": 3, "reps": "do upadku mięśniowego"},
        {"name": "Wiosłowanie sztangą", "sets": 4, "reps": "8-10"},
        {"name": "Ściąganie drążka górnego", "sets": 4, "reps": "10-12"},
        {"name": "Uginanie ramion ze sztangą", "sets": 3, "reps": "8-10"},
        {"name": "Uginanie ramion młotkowe", "sets": 3, "reps": "10-12"}
    ]
},
{
    "day": "Piątek",
    "workout": "Nogi i barki",
    "exercises": [
        {"name": "Przysiady", "sets": 4, "reps": "8-10"},
        {"name": "Wyciskanie nóg na suwnicy", "sets": 4, "reps": "10-12"},
        {"name": "Wspięcia na palce (łydki)", "sets": 4, "reps": "12-15"},
        {"name": "Wyciskanie nad głowę", "sets": 4, "reps": "8-10"},
        {"name": "Unoszenie ramion na boki", "sets": 3, "reps": "10-12"}
    ]
}
            ]
        },
        {
  "id": 2,
  "goal": "Zwiększenie siły",
  "location": "Siłownia",
  "experience": "Zaawansowany",
  "equipment": "Pełny dostęp do siłowni",
  "health_limitations": "Brak",
  "details": [
    {
      "day": "Wtorek",
      "workout": "Trening całego ciała - ciężkie podnoszenie",
      "exercises": [
        {"name": "Martwy ciąg", "sets": 5, "reps": "5"},
        {"name": "Wyciskanie na ławce", "sets": 5, "reps": "5"},
        {"name": "Przysiady", "sets": 5, "reps": "5"}
      ]
    },
    {
      "day": "Czwartek",
      "workout": "Siła górnej części ciała",
      "exercises": [
        {"name": "Wyciskanie żołnierskie", "sets": 5, "reps": "5"},
        {"name": "Podciąganie na drążku", "sets": 5, "reps": "do upadku mięśniowego"},
        {"name": "Wiosłowanie sztangą", "sets": 5, "reps": "5"}
      ]
    },
    {
      "day": "Sobota",
      "workout": "Siła dolnej części ciała",
      "exercises": [
        {"name": "Przysiady przednie", "sets": 5, "reps": "5"},
        {"name": "Martwy ciąg", "sets": 5, "reps": "5"},
        {"name": "Wyciskanie nóg na suwnicy", "sets": 5, "reps": "5"}
      ]
    }
  ]
},
       ...
       {
  "id": 3,
  "goal": "Poprawa wytrzymałości kardio",
  "location": "Na zewnątrz",
  ...
  "details": [
    {
      ...
      "workout": "Lekki bieg",
      "exercises": [
        {"name": "Bieganie", "duration": "30 minut", "pace": "Umiarkowane"}
      ]
    },
    {
      "day": "Środa",
      "workout": "Trening interwałowy",
      "exercises": [
        {"name": "Sprinty", "repeats": "10", "sprint_duration": "30 sekund", "rest_duration": "1 minuta"}
      ]
    },
    {
      "day": "Piątek",
      "workout": "Bieg długodystansowy",
      "exercises": [
        {"name": "Bieganie", "duration": "60 minut", "pace": "Stałe"}
      ]
    }
  ]
},
  ...
  "details": [
    {
      "day": "Poniedziałek",
      "workout": "Trening obwodowy",
      "exercises": [
        {"name": "Przysiady", "sets": 3, "reps": "10"},
        {"name": "Pompki", "sets": 3, "reps": "10"},
        {"name": "Podciąganie na drążku", "sets": 3, "reps": "do upadku mięśniowego"},
        {"name": "Deska (plank)", "duration": "1 minuta"}
      ]
    },
    {
      "day": "Środa",
      "workout": "Trening mięśni brzucha",
      "exercises": [
        {"name": "Skręty rosyjskie (Russian Twists)", "sets": 3, "reps": "15"},
        {"name": "Unoszenie nóg", "sets": 3, "reps": "12"},
        {"name": "Rowerki brzuszne (Bicycle Crunches)", "sets": 3, "reps": "15"}
      ]
    },
    {
      "day": "Piątek",
      "workout": "Zwinność i koordynacja",
      "exercises": [
        {"name": "Ćwiczenia na drabince (Ladder Drills)", "duration": "15 minut"},
        {"name": "Ćwiczenia z pachołkami (Cone Drills)", "duration": "15 minut"},
        {"name": "Wskoki na skrzynię (Box Jumps)", "sets": 3, "reps": "10"}
      ]
    }
  ]
},

{
  ...
  "details": [
    {
      "day": "Poniedziałek",
      "workout": "Mieszanka cardio",
      "exercises": [
        {"name": "Pajacyki", "duration": "5 minut"},
        {"name": "Bieganie w miejscu", "duration": "5 minut"},
        {"name": "Burpees", "sets": 4, "reps": "10"}
      ]
    },
    {
      "day": "Środa",
      "workout": "Siła i cardio",
      "exercises": [
        {"name": "Przysiady", "sets": 3, "reps": "15"},
        {"name": "Pompki", "sets": 3, "reps": "12"},
        {"name": "Skakanie na skakance", "duration": "10 minut"}
      ]
    },
    {
      "day": "Piątek",
      "workout": "Trening interwałowy o wysokiej intensywności",
      "exercises": [
        {"name": "Obwód HIIT", "duration": "20 minut", "details": "30 sekund pracy, 30 sekund odpoczynku"}
      ]
    }
  ]
},
...
{
  "id": 6,
  "goal": "Zaawansowany trening obwodowy",
  "location": "Siłownia",
  "experience": "Zaawansowany",
  "equipment": "Pełny dostęp do siłowni",
  "health_limitations": "Brak",
  "details": [
    {
      "day": "Wtorek",
      "workout": "Obwód na górną część ciała",
      "exercises": [
        {"name": "Wyciskanie na ławce", "sets": 3, "reps": "10"},
        {"name": "Wiosłowanie sztangą", "sets": 3, "reps": "10"},
        {"name": "Pompki na poręczach (dips)", "sets": 3, "reps": "do upadku mięśniowego"}
      ]
    },
    {
      "day": "Czwartek",
      "workout": "Obwód na dolną część ciała",
      "exercises": [
        {"name": "Wyciskanie nóg na suwnicy", "sets": 3, "reps": "10"},
        {"name": "Martwy ciąg", "sets": 3, "reps": "10"},
        {"name": "Wykroki", "sets": 3, "reps": "10 na nogę"}
      ]
    },
    {
      "day": "Sobota",
      "workout": "Obwód na mięśnie brzucha",
      "exercises": [
        {"name": "Deska (plank)", "duration": "1 minuta"},
  ...
  {
  "id": 7,
  "goal": "Poprawa mobilności",
  "location": "Dom",
  "experience": "Początkujący",
  "equipment": "Minimalny (mata do jogi)",
  "health_limitations": "Ograniczona mobilność",
  "details": [
    {
      "day": "Poniedziałek",
      "workout": "Rozciąganie i joga",
      "exercises": [
        {"name": "Rozciąganie całego ciała", "duration": "30 minut"},
        {"name": "Sekwencja jogi", "duration": "30 minut"}
      ]
    },
    {
      "day": "Środa",
      "workout": "Ćwiczenia równowagi",
      "exercises": [
        {"name": "Przysiady na piłce Bosu", "sets": 3, "reps": "10"},
        {"name": "Stanie na jednej nodze", "sets": 3, "duration": "30 sekund na nogę"}
      ]
    },
    {
      "day": "Piątek",
      "workout": "Pilates",
      "exercises": [
        {"name": "Runda pilatesu", "duration": "30 minut"}
      ]
    }
  ]
},
...
{
  "id": 8,
  "goal": "Trening siłowy dla kobiet",
  "location": "Siłownia",
  "experience": "Średnio zaawansowany",
  "equipment": "Pełny dostęp do siłowni",
  "health_limitations": "Brak",
  "details": [
    {
      "day": "Wtorek",
      "workout": "Górna część ciała",
      "exercises": [
        {"name": "Wyciskanie na ławce", "sets": 4, "reps": "10"},
        {"name": "Podciąganie z pomocą (Assisted Pull-ups)", "sets": 4, "reps": "8"},
        {"name": "Wiosłowanie hantlami", "sets": 4, "reps": "12"}
      ]
    },
    {
      "day": "Czwartek",
      "workout": "Nogi i pośladki",
      "exercises": [
        {"name": "Przysiady", "sets": 4, "reps": "10"},
        {"name": "Martwy ciąg na jednej nodze", "sets": 3, "reps": "8 na nogę"},
        {"name": "Wykroki z hantlami", "sets": 4, "reps": "10 na nogę"}
      ]
    },
    {
      "day": "Sobota",
      "workout": "Mięśnie brzucha i rozciąganie",
      "exercises": [
        {"name": "Deska (Plank)", "duration": "1 minuta"},
        {"name": "Unoszenie nóg", "sets": 3, "reps": "15"},
        {"name": "Sekwencja rozciągania", "duration": "15 minut"}
      ]
    }
  ]
},
 ...
 {
  "id": 9,
  "goal": "Trening siłowy dla mężczyzn",
  "location": "Siłownia",
  "experience": "Zaawansowany",
  "equipment": "Pełny dostęp do siłowni",
  "health_limitations": "Brak",
  "details": [
    {
      ...
      "workout": "Górna część ciała",
      "exercises": [
        {"name": "Wyciskanie na ławce", "sets": 4, "reps": "5"},
        {"name": "Rozpiętki na bramie", "sets": 4, "reps": "8"},
        {"name": "Podciąganie szerokim chwytem", "sets": 3, "reps": "do upadku mięśniowego"}
      ]
    },
    {
      "day": "Środa",
      "workout": "Dolna część ciała",
      "exercises": [
        {"name": "Przysiady ze sztangą", "sets": 5, "reps": "5"},
        {"name": "Martwy ciąg", "sets": 4, "reps": "5"},
        {"name": "Wykroki ze sztangą", "sets": 3, "reps": "10 na nogę"}
      ]
    },
    {
      "day": "Piątek",
      "workout": "Mięśnie brzucha i kondycja",
      "exercises": [
        {"name": "Unoszenie nóg w zwisie", "sets": 4, "reps": "10"},
        {"name": "Skręty rosyjskie z hantlem", "sets": 3, "reps": "15"},
        {"name": "Bieganie interwałowe", "duration": "20 minut", "details": "30 sekund sprintu, 1 minuta marszu"}
      ]
    }
  ]
},
...
{
  "id": 10,
  "goal": "Program utrzymania formy",
  "location": "Na zewnątrz",
  "experience": "Średnio zaawansowany",
  "equipment": "Minimalny",
  "health_limitations": "Drobne problemy ze stawami",
  "details": [
    {
      "day": "Poniedziałek",
      "workout": "Lekki trening górnej części ciała",
      "exercises": [
        {"name": "Pompki", "sets": 3, "reps": "15"},
        {"name": "Pompki na krześle (Chair Dips)", "sets": 3, "reps": "12"},
        {"name": "Wyciskanie hantli nad głowę", "sets": 3, "reps": "12"}
      ]
    },
    {
      "day": "Środa",
      "workout": "Lekki trening nóg i mięśni brzucha",
      "exercises": [
        {"name": "Przysiady przy ścianie", "sets": 3, "reps": "15"},
        {"name": "Unoszenie nóg", "sets": 3, "reps": "10"},
        {"name": "Deska (Plank)", "duration": "30 sekund", "sets": 3}
      ]
    },
    {
      "day": "Piątek",
      "workout": "Cardio i mobilność",
      "exercises": [
        {"name": "Żwawy marsz", "duration": "30 minut"},
        {"name": "Dynamiczne rozciąganie", "duration": "10 minut"},
        {"name": "Joga", "duration": "20 minut"}]}]}]
...
def achievements():
    ...
    test_achievements = [
        {
            'title': 'Uzupelniony profil',
            'description': 'Twój profil jest w pełni wypełniony!',
            'category': 'Profil',
            'icon': 'icons/profile_complete.png',
            'created_at': datetime.utcnow()
        },
        {
            'title': 'Pierwszy wpis w dzienniku',
            'description': 'Twój pierwszy wpis w dzienniku!',
            'category': 'Dziennik',
